...
$sql = "INSERT INTO coupongeneration (discount_on, Coupon_id, pin, StartingDate, EndingDate) 
        VALUES ('$discount_on', '$res', $pinres, '$sd1', '$d1')";
    ...
    <div class="header">
        ...
        <center>
            <div class="myDiv">
                <table>
                <tr>
                    <td><div class="Div1" colspan="4">Product</div></td>
                    <td>-</td>
                    <td><input type="text"></td>
                </tr>
                <tr>
                    <td><div class="Div1" colspan="4">Discount Percentage</div></td>
                    <td>-</td>
                    <td><input type="text"></td>
                </tr>
                <tr>
                    ...
                    <td>-</td>
                    <td><button>Generate CouponID</button></td>
                </tr>
                <tr>
                    <td><div class="Div1" colspan="4">Pin</div></td>
                    <td>-</td>
                    <td><button>Generate Pin</button></td>
                </tr>
